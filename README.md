...
|---|---|---|
| **CDA Trading Bot** | Multi-instance algorithmic trading platform with microservices, backtest engine, and strategy execution | NestJS · MongoDB · Redis · BullMQ · Docker · WebSocket |
| **Kvants AI Bybit Platform** | Full-featured crypto trading dashboard with AI signals, OAuth 2.0 social auth, Stripe billing, and KYC | Next.js · Express · MongoDB · Redis · OAuth 2.0 · Wagmi |
| **EVM Arbitrage Bot** | Real-time EVM arbitrage detection and execution bot with NestJS microservices and Prisma ORM | NestJS · Prisma · Ethers.js · PostgreSQL · WebSocket |
| **Sauron 2.0** | DeFi trading and portfolio management platform | Next.js · Wagmi · Viem · TanStack Query |
| **PumpFun Trading Bot** | Solana-based memecoin trading bot with real-time price feeds | React · Solana Web3.js · Radix UI |
